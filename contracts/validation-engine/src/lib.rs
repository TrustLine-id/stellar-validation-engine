...
//! Injectable Validation Engine.
//!
//! Constructor takes a `registry` address — used by unit tests and generic deploys.
//! Production Trustline deployments use `trustline-oracle-ve` with a hardcoded registry.
